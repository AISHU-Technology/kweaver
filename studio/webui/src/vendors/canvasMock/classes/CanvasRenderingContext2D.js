...
export default class CanvasRenderingContext2D {
  ...
  addHitRegion(options = {}) {
    ...
    if (!path && !id) {
      throw new DOMException(
        'ConstraintError',
        `Failed to execute 'addHitRegion' on '${this.constructor.name}': Both id and control are null.`
      );
    }
    if (fillRule && fillRule !== 'evenodd' && fillRule !== 'nonzero') {
      throw new TypeError(
        `Failed to execute 'addHitRegion' on '${this.constructor.name}': The provided value '${fillRule}' is not a valid enum value of type CanvasFillRule.`
      );
    }
    this._events.push(
      createCanvasEvent('addHitRegion', getTransformSlice(this), {
        path,
        fillRule,
        id,
        parentID,
  ...
  arc(x, y, radius, startAngle, endAngle, anticlockwise = false) {
    if (arguments.length < 5) {
      throw new TypeError(
        `Failed to execute 'arc' on '${this.constructor.name}': 5 arguments required, but only ${arguments.length} present.`
      );
    }
    ...
    if (!Number.isFinite(xResult + yResult + radiusResult + startAngleResult + endAngleResult)) {
      return;
    }
    ...
    if (Number(radius) < 0) {
      throw new DOMException(
        'IndexSizeError',
        `Failed to execute 'arc' on '${this.constructor.name}': The radius provided (${radius}) is negative.`
      );
    }
  ...
  arcTo(cpx1, cpy1, cpx2, cpy2, radius) {
    if (arguments.length < 5) {
      throw new DOMException(
        'IndexSizeError',
        `Failed to execute 'arcTo' on '${this.constructor.name}': 5 arguments required, but only ${arguments.length} present.`
      );
    }
    ...
    if (!Number.isFinite(cpx1Result + cpx2Result + cpy1Result + cpy2Result + radiusResult)) {
      return;
    }
    if (radiusResult < 0) {
      throw new TypeError(
        `Failed to execute 'arcTo' on '${this.constructor.name}': The radius provided (${radius}) is negative.`
      );
    }
  ...
  bezierCurveTo(cpx1, cpy1, cpx2, cpy2, x, y) {
    if (arguments.length < 6) {
      throw new TypeError(
        `Failed to execute 'bezierCurveTo' on '${this.constructor.name}': 6 arguments required, but only ${arguments.length} present.`
      );
    }
    const cpx1Result = Number(cpx1);
    const cpy1Result = Number(cpy1);
    ...
    if (!Number.isFinite(cpx1Result + cpy1Result + cpx2Result + cpy2Result + xResult + yResult)) {
      return;
    }
  ...
  clearRect(x, y, width, height) {
    if (arguments.length < 4) {
      throw new TypeError(
        `Failed to execute 'clearRect' on '${this.constructor.name}': 4 arguments required, but only ${arguments.length} present.`
      );
    }
    ...
    if (arguments.length === 0) {
      ...
      if (path instanceof Path2D) {
        ...
        if (fillRule !== 'nonzero' && fillRule !== 'evenodd') {
          throw new TypeError(
            `Failed to execute 'clip' on '${this.constructor.name}': The provided value '${fillRule}' is not a valid enum value of type CanvasFillRule.`
          );
        }
  ...
  createImageData(width, height) {
    if (arguments.length < 1) {
      throw new TypeError(
        `Failed to execute 'createImageData' on '${this.constructor.name}': 1 argument required, but only 0 present.`
      );
    } else if (arguments.length === 1) {
      if (!(width instanceof ImageData)) {
        throw new TypeError(
          `Failed to execute 'createImageData' on '${this.constructor.name}': parameter 1 is not of type 'ImageData'.`
        );
      }
      ...
      if (!Number.isFinite(width) || width === 0) {
        throw new TypeError(
          `Failed to execute 'createImageData' on '${this.constructor.name}': The source width is 0.`
        );
      }
      if (!Number.isFinite(height) || height === 0) {
        throw new TypeError(
          `Failed to execute 'createImageData' on '${this.constructor.name}': The source height is 0.`
        );
      }
      const event = createCanvasEvent('createImageData', getTransformSlice(this), { width, height });
      this._events.push(event);
  ...
  createLinearGradient(x0, y0, x1, y1) {
    if (arguments.length < 4) {
      throw new TypeError(
        `Failed to execute 'createLinearGradient' on '${this.constructor.name}': 4 arguments required, but only ${arguments.length} present.`
      );
    }
    ...
    if (!Number.isFinite(x0Result + y0Result + x1Result + y1Result)) {
      throw new TypeError(
        `Failed to execute 'createLinearGradient' on '${this.constructor.name}': The provided double value is non-finite.`
      );
    }
  ...
  createPattern(image, type) {
    if (arguments.length === 1) {
      throw new TypeError(
        `Failed to execute 'createPattern' on '${this.constructor.name}': 2 arguments required, but only 1 present.`
      );
    }
    ...
    if (type === 'repeat' || type === 'repeat-x' || type === 'repeat-y' || type === 'no-repeat') {
      const event = createCanvasEvent('createPattern', getTransformSlice(this), { image, type });
      ...
      throw new TypeError(
        `Failed to execute 'createPattern' on '${this.constructor.name}': The provided type ('${type}') is not one of 'repeat', 'no-repeat', 'repeat-x', or 'repeat-y'.`
      );
    }

    throw new TypeError(
      `Failed to execute 'createPattern' on '${this.constructor.name}': The provided value is not of type '(CSSImageValue or HTMLImageElement or SVGImageElement or HTMLVideoElement or HTMLCanvasElement or ImageBitmap or OffscreenCanvas)'`
    );
  }
  ...
  createRadialGradient(x0, y0, r0, x1, y1, r1) {
    if (arguments.length < 6) {
      throw new TypeError(
        `Failed to execute 'createRadialGradient' on '${this.constructor.name}': 6 arguments required, but only ${arguments.length} present.`
      );
    }
    const x0Result = Number(x0);
    const y0Result = Number(y0);
    ...
    if (!Number.isFinite(x0Result + y0Result + r0Result + x1Result + y1Result + r1Result)) {
      throw new TypeError(
        `Failed to execute 'createRadialGradient' on '${this.constructor.name}': The provided double value is non-finite.`
      );
    }
    if (r0Result < 0) {
      throw new DOMException(
        'IndexSizeError',
        `Failed to execute 'createRadialGradient' on '${this.constructor.name}': The r0 provided is less than 0.`
      );
    }
    if (r1Result < 0) {
      throw new DOMException(
        'IndexSizeError',
        `Failed to execute 'createRadialGradient' on '${this.constructor.name}': The r1 provided is less than 0.`
      );
    }
  ...
  set direction(value) {
    if (value === 'rtl' || value === 'ltr' || value === 'inherit') {
      ...
      const event = createCanvasEvent('direction', getTransformSlice(this), {
        value
      });
      this._events.push(event);
    }
  ...
  drawFocusIfNeeded(path, element) {
    if (arguments.length === 0) {
      throw new TypeError(
        `Failed to execute 'drawFocusIfNeeded' on '${this.constructor.name}': 1 argument required, but only 0 present.`
      );
    }
    if (arguments.length === 2 && !(path instanceof Path2D)) {
      throw new TypeError(
        `Failed to execute 'drawFocusIfNeeded' on '${this.constructor.name}': parameter 1 is not of type 'Path2D'.`
      );
    }
    ...
    if (!(element instanceof Element)) {
      throw new TypeError(
        `Failed to execute 'drawFocusIfNeeded' on '${this.constructor.name}': parameter ${arguments.length} is not of type 'Element'.`
      );
    }
  ...
  drawImage(img, sx, sy, sWidth, sHeight, dx, dy, dWidth, dHeight) {
    if (arguments.length < 3) {
      throw new TypeError(
        `Failed to execute 'drawImage' on '${this.constructor.name}': 3 arguments required, but only ${arguments.length} present.`
      );
    }
    if (arguments.length === 4 || (arguments.length > 5 && arguments.length < 9)) {
      throw new TypeError(
        `Failed to execute 'drawImage' on '${this.constructor.name}': Valid arities are: [3, 5, 9], but 4 arguments provided.`
      );
    }
    ...
    if (!valid) {
      throw new TypeError(
        `Failed to execute 'drawImage' on '${this.constructor.name}': The provided value is not of type '(CSSImageValue or HTMLImageElement or SVGImageElement or HTMLVideoElement or HTMLCanvasElement or ImageBitmap or OffscreenCanvas)'`
      );
    }
    ...
    if (arguments.length === 3) {
      ...
      if (!Number.isFinite(sxResult + syResult + sWidthResult + sHeightResult)) {
        return;
      }
      sx = 0;
      sy = 0;
      ...
      if (!Number.isFinite(sx + sy + sWidth + sHeight + dx + dy + dWidth + dHeight)) {
        return;
      }
      sx = sxResult;
      sy = syResult;
  ...
  ellipse(x, y, radiusX, radiusY, rotation, startAngle, endAngle, anticlockwise = false) {
    if (arguments.length < 7) {
      throw new TypeError(
        `Failed to execute 'ellipse' on '${this.constructor.name}': 6 arguments required, but only ${arguments.length} present.`
      );
    }
    const xResult = Number(x);
    const yResult = Number(y);
    ...
    if (
      !Number.isFinite(
        xResult + yResult + radiusXResult + radiusYResult + rotationResult + startAngleResult + endAngleResult
      )
    ) {
      return;
    }
    ...
    if (Number(radiusX) < 0) {
      throw new DOMException(
        'IndexSizeError',
        `Failed to execute 'ellipse' on '${this.constructor.name}': The major-axis radius provided (${radiusX}) is negative.`
      );
    }
    if (Number(radiusY) < 0) {
      throw new DOMException(
        'IndexSizeError',
        `Failed to execute 'ellipse' on '${this.constructor.name}': The minor-axis radius provided (${radiusY}) is negative.`
      );
    }
  ...
  fillRect(x, y, width, height) {
    if (arguments.length < 4) {
      throw new TypeError(
        `Failed to execute 'fillRect' on '${this.constructor.name}': 4 arguments required, but only ${arguments.length} present.`
      );
    }
  ...
  set fillStyle(value) {
    ...
    if (typeof value === 'string') {
      try {
        valid = true;
        value = this._fillStyleStack[this._stackIndex] || '#000000';
      } catch (e) {
        return;
      }
    ...
    if (valid) {
      const event = createCanvasEvent('fillStyle', getTransformSlice(this), {
        value
      });
      this._events.push(event);
    }
  ...
  fillText(text, x, y, maxWidth) {
    if (arguments.length < 3) {
      throw new TypeError(
        `Failed to execute 'fillText' on '${this.constructor.name}': 3 arguments required, but only ${arguments.length} present.`
      );
    }
    ...
    if (arguments.length > 3 && !Number.isFinite(xResult + yResult + maxWidthResult)) {
      return;
    }
  ...
  set filter(value) {
    ...
    const event = createCanvasEvent('filter', getTransformSlice(this), {
      value
    });
    this._events.push(event);
  }
  ...
  set font(value) {
    ...
    try {
      const result = '15px/18px Helvetica, sans-serif';
      value = this._fontStack[this._stackIndex] = result;
      const event = createCanvasEvent('font', getTransformSlice(this), {
        value
      });
      this._events.push(event);
    } catch (ex) {}
  ...
  set globalAlpha(value) {
    ...
    const event = createCanvasEvent('globalAlpha', getTransformSlice(this), {
      value
    });
    this._events.push(event);
  }
  ...
  isPointInPath(path, x, y, fillRule = 'nonzero') {
    if (arguments.length < 2) {
      throw new TypeError(
        `Failed to execute 'isPointInPath' on '${this.constructor.name}': 2 arguments required, but only ${arguments.length} present.`
      );
    }
    if (!(path instanceof Path2D)) {
      if (arguments.length > 2) {
    ...
    if (fillRule !== 'nonzero' && fillRule !== 'evenodd') {
      throw new TypeError(
        `Failed to execute 'isPointInPath' on '${this.constructor.name}': The provided value '${fillRule}' is not a valid enum value of type CanvasFillRule.`
      );
    }
  ...
  isPointInStroke(path, x, y) {
    if (arguments.length < 2) {
      throw new TypeError(
        `Failed to execute 'isPointInStroke' on '${this.constructor.name}': 2 arguments required, but only ${arguments.length} present.`
      );
    }
    if (!(path instanceof Path2D)) {
      y = x;
  ...
  set lineCap(value) {
    if (value === 'butt' || value === 'round' || value === 'square') {
      ...
      const event = createCanvasEvent('lineCap', getTransformSlice(this), {
        value
      });
      this._events.push(event);
    }
  ...
  set lineJoin(value) {
    if (value === 'round' || value === 'bevel' || value === 'miter') {
      ...
      const event = createCanvasEvent('lineJoin', getTransformSlice(this), {
        value
      });
      this._events.push(event);
    }
  ...
  lineTo(x, y) {
    if (arguments.length < 2) {
      throw new TypeError(
        `Failed to execute 'lineTo' on '${this.constructor.name}': 2 arguments required, but only ${arguments.length} present.`
      );
    }
    const xResult = Number(x);
    const yResult = Number(y);
  ...
  measureText(text) {
    if (arguments.length < 1) {
      throw new TypeError(
        `Failed to execute 'measureText' on '${this.constructor.name}': 1 argument required, but only 0 present.`
      );
    }
    text = text == null ? '' : text;
    text = text.toString();
    const event = createCanvasEvent('measureText', getTransformSlice(this), {
      text
    });
    this._events.push(event);
  ...
  moveTo(x, y) {
    if (arguments.length < 2) {
      throw new TypeError(
        `Failed to execute 'moveTo' on '${this.constructor.name}': 2 arguments required, but only ${arguments.length} present.`
      );
    }
    const xResult = Number(x);
    const yResult = Number(y);
  ...
  putImageData(data, x, y, dirtyX, dirtyY, dirtyWidth, dirtyHeight) {
    if (arguments.length < 3) {
      throw new TypeError(
        `Failed to execute 'putImageData' on '${this.constructor.name}': 3 arguments required, but only ${arguments.length} present.`
      );
    }
    if (arguments.length > 3 && arguments.length < 7) {
      throw new TypeError(
        `Failed to execute 'putImageData' on '${this.constructor.name}': Valid arities are: [3, 7], but ${arguments.length} arguments provided.`
      );
    }
    if (!(data instanceof ImageData)) {
      throw new TypeError(
        `Failed to execute 'putImageData' on '${this.constructor.name}': parameter 1 is not of type 'ImageData'.`
      );
    }
    ...
    if (arguments.length === 3) {
      ...
      !Number.isFinite(xResult + yResult + dirtyXResult + dirtyYResult + dirtyWidthResult + dirtyHeightResult)
    ) {
      return;
    }
  ...
  quadraticCurveTo(cpx, cpy, x, y) {
    if (arguments.length < 4) {
      throw new TypeError(
        `Failed to execute 'quadraticCurveTo' on '${this.constructor.name}': 4 arguments required, but only ${arguments.length} present.`
      );
    }
  ...
  rect(x, y, width, height) {
    if (arguments.length < 4) {
      throw new TypeError(
        `Failed to execute 'rect' on '${this.constructor.name}': 4 arguments required, but only ${arguments.length} present.`
      );
    }
    if (!Number.isFinite(x + y + width + height)) return;
  ...
  removeHitRegion(id) {
    if (arguments.length < 1) {
      throw new TypeError(
        `Failed to execute 'removeHitRegion' on '${this.constructor.name}': 1 argument required, but only ${arguments.length} present.`
      );
    }
  ...
  rotate(angle) {
    if (arguments.length < 1) {
      throw new TypeError(
        `Failed to execute 'rotate' on '${this.constructor.name}': 1 argument required, but only 0 present.`
      );
    }
    angle = Number(angle);
  ...
  scale(x, y) {
    if (arguments.length < 2) {
      throw new TypeError(
        `Failed to execute 'scale' on '${this.constructor.name}': 2 arguments required, but only ${arguments.length} present.`
      );
    }
    const xResult = Number(x);
    const yResult = Number(y);
  ...
  scrollPathIntoView(path) {
    if (arguments.length > 0 && path instanceof Path2D) {
      path = path._path.slice();
  ...
  setLineDash(lineDash) {
    ...
    if (!isSequence) {
      throw new TypeError(
        `Failed to execute 'setLineDash' on '${this.constructor.name}': The provided value cannot be converted to a sequence.`
      );
    }
    let result = [];
  ...
  setTransform(a, b, c, d, e, f) {
    if (arguments.length === 0) {
      ...
      if (a instanceof DOMMatrix) {
        ...
        throw new TypeError(
          `Failed to execute 'setTransform' on '${this.constructor.name}': parameter ${a} ('transform') is not an object.`
        );
      }
    } else if (arguments.length < 6) {
      throw new TypeError(
        `Failed to execute 'setTransform' on '${this.constructor.name}': Valid arities are: [0, 1, 6], but ${arguments.length} arguments provided.`
      );
    }
    a = Number(a);
    b = Number(b);
  ...
  set shadowBlur(value) {
    ...
    if (Number.isFinite(result) && result > 0) {
      ...
      const event = createCanvasEvent('shadowBlur', getTransformSlice(this), {
        value: result
      });
      this._events.push(event);
    }
  ...
  set shadowColor(value) {
    if (typeof value === 'string') {
      try {
        value = this._shadowColorStack[this._stackIndex] || '#000000';
      } catch (e) {
        return;
      }

      const event = createCanvasEvent('shadowColor', getTransformSlice(this), {
        value
      });
      this._events.push(event);
    }
  ...
  stroke(path) {
    if (arguments.length === 0) {
      ...
      if (!(path instanceof Path2D)) {
        throw new TypeError(
          `Failed to execute 'stroke' on '${this.constructor.name}': parameter 1 is not of type 'Path2D'.`
        );
      }
      path = path._path.slice();
    }

    const event = createCanvasEvent('stroke', getTransformSlice(this), {
      path
    });
    this._events.push(event);
    this._drawCalls.push(event);
  ...
  strokeRect(x, y, width, height) {
    if (arguments.length < 4) {
      throw new TypeError(
        `Failed to execute 'strokeRect' on '${this.constructor.name}': 4 arguments required, but only ${arguments.length} present.`
      );
    }
    x = Number(x);
    y = Number(y);
  ...
  set strokeStyle(value) {
    ...
    if (typeof value === 'string') {
      try {
        valid = true;
        value = this._strokeStyleStack[this._stackIndex] || '#000000';
      } catch (e) {
        return;
      }
    } else if (value instanceof CanvasGradient || value instanceof CanvasPattern) {
    ...
    if (valid) {
      const event = createCanvasEvent('strokeStyle', getTransformSlice(this), {
        value
      });
      this._events.push(event);
    }
  ...
  strokeText(text, x, y, maxWidth) {
    if (arguments.length < 3) {
      throw new TypeError(
        `Failed to execute 'strokeText' on '${this.constructor.name}': 3 arguments required, but only ${arguments.length} present.`
      );
    }
    const textResult = String(text);
    const xResult = Number(x);
  ...
  set textAlign(value) {
    if (value === 'left' || value === 'right' || value === 'center' || value === 'start' || value === 'end') {
      ...
      const event = createCanvasEvent('textAlign', getTransformSlice(this), {
        value
      });
      this._events.push(event);
    }
  ...
  set textBaseline(value) {
    if (
      ...
      const event = createCanvasEvent('textBaseline', getTransformSlice(this), {
        value
      });
      this._events.push(event);
    }
  ...
  transform(a, b, c, d, e, f) {
    if (arguments.length < 6) {
      throw new TypeError(
        `Failed to execute 'transform' on '${this.constructor.name}': 6 arguments required, but only ${arguments.length} present.`
      );
    }
  ...
  translate(x, y) {
    if (arguments.length < 2) {
      throw new TypeError(
        `Failed to execute 'translate' on '${this.constructor.name}': 2 arguments required, but only ${arguments.length} present.`
      );
    }
    const xResult = Number(x);
    const yResult = Number(y);
