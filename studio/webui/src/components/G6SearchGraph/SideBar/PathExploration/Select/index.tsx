  ...
  const getValue = (node: any) => {
    ...
    if (node?.id) {
      return {
        ...
        label:
          <div className="ad-ellipsis" title={item?.data?.name}>
            <span
    ...
    <div className="pathExplore-select-box" id="pathExplore-select-box">
        ...
        <div className="select-box-left" id="select-box-left">
          <div className="startpoint">
            ...
            >
              {
                nodes.map(item => (
                  <Select.Option key={item?.data?.id} value={item?.data?.name}>
                    <div className="ad-ellipsis" title={item?.data?.name}>
          ...
          <div className="endpoint">
            ...
            >
              {nodes.map(item => (
                <Select.Option key={item?.data?.id} value={item?.data?.name}>
                  <div className="ad-ellipsis" title={item?.data?.name}>
                    <span className="selectOption" style={{ background: item?.data?.color }}>
                    </span>
                    {item?.data?.name}
                  </div>
                </Select.Option>
      ...
      <div className="expore-btn-box">
        <Button
          ...
          type="primary" className="expore-btn"
