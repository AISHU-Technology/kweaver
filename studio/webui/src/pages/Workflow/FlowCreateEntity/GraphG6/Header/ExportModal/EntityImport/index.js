...
class EntityImport extends Component {
  ...
  onChange = async value => {
    ...
    const { res, Code, Cause = '' } = (await servicesCreateEntity.getEntityInfo(decodeURI(ontology_id))) || {};
    ...
    this.setState({ graphData: data, selectValue: value });
    switch (true) {
      case Code === 500403:
    ...
    this.props.setSaveData({ data, type: 'entity' }); // 将预测出点数据传回父组件
  };
