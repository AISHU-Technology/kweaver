    ...
    <div className="summary-graph-node-list-root">
      ...
      <div ref={scrollRef as any} className="list-scroll-wrap">
        <div className="scroll-box">
          {_.map(data, item => {
            const { alias, color, sourceAlias, targetAlias } = item;
            ...
            return (
              <div
                key={key}
                className={classNames('list-item ad-align-center ad-pointer', { checked: isChecked, error: isErr })}
              >
                <div
                ...
                <div className="info-wrap ad-space-between" onClick={() => onRowClick?.(item)}>
                  <div
                  ...
                  <div className="node-info">
                    ...
                    {type === 'edge' && (
                      <div className="ad-align-center ad-c-subtext">
                        <div className="start-node ad-ellipsis" title={sourceAlias}>
                          {sourceAlias}
                        </div>
                        &nbsp;&gt;&nbsp;
                        <div className="end-node ad-ellipsis" title={targetAlias}>
                          {targetAlias}
                        </div>
                      </div>
                    )}
                  ...
                  {isErr && (
                    ...
                    >
                      <ExclamationCircleOutlined className="ad-c-error ad-ml-2" />
                    </Tooltip>
                  )}

                  <RightOutlined className="ad-ml-2 ad-mr-1" />
                </div>
              </div>
            );
          })}
