...
class Test_addds(TestCase):
    ...
    def test_success(self):
        res = dsm_service.addds(self.params, self.host_url)
...
class Test_getall(TestCase):
    ...
    # success
    def test_success(self):
        res = dsm_service.getall(self.params_json, self.host_url)
        self.assertEqual(res[0], 200)
    ...
    def test_exception(self):
        ...
        res = dsm_service.addds(self.params_json, self.host_url)
        self.assertEqual(res[0], 500)
...
class Test_getbydsname(TestCase):
    ...
    # success
    def test_success(self):
        ret = dsm_service.getbydsname(self.params_json, self.host_url)
    ...
    def test_not_find_knw(self):
        ...
        res = dsm_service.getbydsname(self.params_json, self.host_url)
        self.assertEqual(res[0], 500)
...
class Test_update(TestCase):
    ...
    def test_success(self):
        res = dsm_service.update(1, self.params_json, self.host_url)
        self.assertEqual(res[0], 200)
...
class Test_delete(TestCase):
    ...
    def test_success(self):
        res = dsm_service.delete(self.params_json, self.host_url)
        self.assertEqual(res[0], 200)
