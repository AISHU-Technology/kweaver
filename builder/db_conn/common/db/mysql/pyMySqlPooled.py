import time
import pymysql
from common.db.mysql.mysqlPoolConn import pooled_db_connection
from timeit import default_timer
from common.log.logger import logger


# 建立MySQL的连接
class DBMySqlPooledLib(object):
    ...
    def __init__(self,  **kwargs):
        ...
        #
        # self.db_config =pooled_db_connection
    ...
    def __enter__(self):
        ...
        conn = pooled_db_connection.get_conn()
