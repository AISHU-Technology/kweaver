...
'''
    {
        ...
        "cause": "[cause]",
        "solution": "请检查OrientDB请求信息是否正确"
    }
'''
Builder_GraphdbDao_GetPropertiesOrientdb_OrientdbRequestError = 'Builder.GraphdbDao.GetPropertiesOrientdb.OrientdbRequestError'
...
'''
    {
        ...
        "description": "[description]",
        "cause": "[cause]",
        "solution": "请检查Nebula请求信息是否正确"
    }
'''
Builder_GraphdbDao_GetPropertiesNebula_NebulaExecError = 'Builder.GraphdbDao.GetPropertiesNebula.NebulaExecError'
...
'''
Builder_GraphdbDao_Count_GraphDBConnectionError = 'Builder.GraphdbDao.Count.GraphDBConnectionError'
...
'''
Builder_GraphdbDao_Count_DBNameNotExitsError = 'Builder.GraphdbDao.Count.DBNameNotExitsError'
...
'''
Builder_GraphdbDao_CountOrientdb_OrientdbRequestError = 'Builder.GraphdbDao.CountOrientdb.OrientdbRequestError'
...
'''
Builder_GraphdbDao_CountNebula_NebulaExecError = 'Builder.GraphdbDao.CountNebula.NebulaExecError'
...
'''
Builder_GraphdbDao_CheckSchemaNebula_NebulaExecError = 'Builder.GraphdbDao.CheckSchemaNebula.NebulaExecError'