...
if __name__ == '__main__':
    ...
    train_file = '/mnt/flora_hu/gbuilder-builder/unstructedmodel/data/Generalmodel_datasets/train_data.json'
    eval_file = '/mnt/flora_hu/gbuilder-builder/unstructedmodel/data/Generalmodel_datasets/dev_data.json'
