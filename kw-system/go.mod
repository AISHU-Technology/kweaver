...
require (
	github.com/AISHU-Technology/kw-go-core v0.0.1
...
require (
	gitee.com/tdxmkf123/gorm-driver-dameng v1.0.2 // indirect
	gitee.com/tdxmkf123/gorm-driver-oracle v1.0.0 // indirect
