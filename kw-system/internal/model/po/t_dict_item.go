...
//var DictionaryItemModel = &TDictItem{}
...
type TDictItem struct {
	...
	DictId     uint64                `gorm:"column:f_dict_id;type:bigint not null;index:idx_dict_item_dict_id"`
	ItemValue  string                `gorm:"column:f_item_value;type:varchar(100) not null;default:''"`
...
func (f *TDictItem) BeforeCreate(tx *gorm.DB) error {
