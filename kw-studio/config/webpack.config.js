    ...
    resolve: {
      ...
      plugins: [
        ...
        new ModuleScopePlugin(paths.appSrc, [
          ...
          // add this line to reslove error when run command `yarn build` in docker container(node:18.12.1)
          // error detail: You attempted to import xxx/node_modules/console browserify/index.js which falls outside of the project src/ directory.
