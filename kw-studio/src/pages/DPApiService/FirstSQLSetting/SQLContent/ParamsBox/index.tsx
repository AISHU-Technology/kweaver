...
import { BasicData, ParamsList as TParamsList } from '../../../SecondPublishAPI/types';
import { EditorStatus } from '../index';
import './style.less';

import AddParamsModal from './Model/addParamsModal';
import RelateModal from './Model/RelateModal';
...
const ParamsBox = (props: ParamsBoxProps) => {
  ...
  return (
    <div className={classNames(className, 'custom-param-box-root kw-flex')}>
      ...
      >
        <div className="paramsListWrapper">
          <div className="tname">{intl.get('dpapiService.parameter')}</div>
