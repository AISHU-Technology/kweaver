...
import { ReloadOutlined, PlusOutlined, EllipsisOutlined } from '@ant-design/icons';
      ...
      render: (_: string, record: any) => {
        return (
          <div className="left-name">
            <div className={'name kw-ellipsis'} title={language === 'en-US' ? record.eName : record.cName}>
              {language === 'en-US' ? record.eName : record.cName}
            </div>
            <div className="type kw-ellipsis" title={record.dictType}>
              {record.dictType}
            </div>
          </div>
        );
