...
import { RelatedDocumentType1, RelatedDocumentType2, TitleObj } from '../../types';
import { validator, verifyTitle, triggerVerify } from '../../validator';
import { buildConfig } from '../components/TestPanel/utils';

type RelatedDocumentType = RelatedDocumentType1 & RelatedDocumentType2;
...
export interface RelatedDocumentProps {
  ...
  data: RelatedDocumentType;
  testOptions?: any;
  externalModel?: any;
  onChange: (newData: Partial<RelatedDocumentType>) => void;
  onViewOntology?: () => void;
}
...
const RelatedDocument = (props: RelatedDocumentProps) => {
  ...
  return (
    <div className={classNames(className, 'knw-card-related-document kw-flex-column kw-h-100')}>
