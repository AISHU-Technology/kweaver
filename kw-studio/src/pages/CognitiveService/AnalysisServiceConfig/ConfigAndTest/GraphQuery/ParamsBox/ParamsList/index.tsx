...
import { ParamsList as TParamsList } from '../../../../types';
import './style.less';
...
const getTypeString = (type: string) => {
  const TYPE_ENUM: Record<string, string> = {
    string: intl.get('function.string'),
    entity: intl.get('function.entity')
  };
