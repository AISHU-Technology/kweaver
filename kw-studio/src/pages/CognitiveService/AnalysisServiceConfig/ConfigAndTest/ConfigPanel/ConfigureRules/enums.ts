...
const _CONSTANT = 'constant'; // 常量
const _CUSTOMVAR = 'custom var'; // 自定义变量
const _SYSTIME = 'time var'; // 系统时间变量

const TODAY = 'today'; // 今天
const LASTWEEK = 'last weekend'; // 上周末
const LASTMONTH = 'end of last month';
const FIRST_OF_WEEK = 'first day of last week';
const FIRST_OF_MONTH = 'first day of last month';
const END_OF_YEAR = 'end of last year';
const FIRST_OF_LAST_YEAR = 'first day of last year';
const END_OF_NEXT_YEAR = 'end of next year';
const FIRST_OF_NEXT_YEAR = 'first day of next year';
...
// 时间属性变量类型
export const TIME_VARIABLE = [
  {
    label: 'cognitiveService.neighbors.constans',
    value: _CONSTANT
  },
  {
    label: 'cognitiveService.neighbors.customVar',
    value: _CUSTOMVAR
  },
  {
    label: 'cognitiveService.neighbors.sysTimeVar',
    value: _SYSTIME
  }
];
...
export const TIME_TYPE = [
  { label: 'cognitiveService.neighbors.today', value: TODAY }, // 今天
  { label: 'cognitiveService.neighbors.lastWeek', value: LASTWEEK }, // 上周末
  { label: 'cognitiveService.neighbors.lasMonth', value: LASTMONTH }, // 上月末
  { label: 'cognitiveService.neighbors.firstOfWeek', value: FIRST_OF_WEEK }, // 上周第一天
  { label: 'cognitiveService.neighbors.firstOfMonth', value: FIRST_OF_MONTH }, // 上月第一天
  { label: 'cognitiveService.neighbors.endOfYear', value: END_OF_YEAR }, // 去年末
  { label: 'cognitiveService.neighbors.firstOfLastYear', value: FIRST_OF_LAST_YEAR }, // 去年第一天
  { label: 'cognitiveService.neighbors.endOfNextyear', value: END_OF_NEXT_YEAR }, // 明年末
  { label: 'cognitiveService.neighbors.firstOfNextYear', value: FIRST_OF_NEXT_YEAR } // 明年第一天
];

// 参数类型
export const PARAM_TYPE = { _SYSTIME, _CONSTANT, _CUSTOMVAR };

// 自定义变量默认值
export const defaultParam_custom = { name: '', alias: '', example: '', description: '' };

// 系统时间变量默认值
export const defaultSysTime = { type: TODAY, offset: 0 };
