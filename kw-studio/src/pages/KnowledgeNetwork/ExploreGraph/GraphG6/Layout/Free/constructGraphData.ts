...
import { nodeSize, edgeLineWidth } from '../../enums';
import { processLoopEdges } from '../../registerLineLoop';
...
export const constructGraphFreeData = (_data: any, cache?: any): any => {
  ...
  // 构建edges
  let edges: any = _.map(data.edges || [], (_item: EdgeType) => {
    const item: any = {
      strokeColor: _item.color,
  ...
  edges = processLoopEdges(edges, 10);
