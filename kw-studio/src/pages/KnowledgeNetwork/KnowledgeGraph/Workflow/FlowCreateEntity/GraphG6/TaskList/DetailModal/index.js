                ...
                <div className="table-content" key={index.toString()}>
                  <div className="content-file">
                    <div className="content-file-name">
                      ...
                      <div
                        className="word"
                        title={wrapperTitle(item[0].includes('/') ? item[0].split('/')[1] : item[0])}
                      >
                        {item[0].includes('/') ? item[0].split('/')[1] : item[0]}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="content-double">
                    ...
                    <div className="name distand" title={wrapperTitle(item[1])}>
                      {['kingbasees', 'postgresql', 'sqlserver'].includes(item[4]) ? item[0] : item[1]}
                    </div>
                  </div>
              ...
              taskList.map((item, index) => {
                return (
                  ...
                  >
                    ...
                    <div
                      className="word"
                      title={wrapperTitle(item.task_name.includes('/') ? item.task_name.split('/')[1] : item.task_name)}
                    >
                      {item.task_name.includes('/') ? item.task_name.split('/')[1] : item.task_name}
                    </div>
                  </div>
                );
              })}
                    ...
                    <div className="word">
                      <div className="name">
                        <div
                          className="name-word"
                          title={wrapperTitle(
                            selectedTask.task_name.includes('/')
                              ? selectedTask.task_name.split('/')[1]
