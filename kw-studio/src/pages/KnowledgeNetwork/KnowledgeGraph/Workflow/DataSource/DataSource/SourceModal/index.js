...
const SourceModal = props => {
  const { operation, selectKey, visible, handleCancel, onSuccess, formInfo } = props;
  ...
  useEffect(() => {
    ...
    form.setFieldsValue({ ...formInfo, data_source: curSource, ds_path: curDSPath });
          ...
          >
            <div className="scroll-wrapper">
              ...
              >
                ...
                {/* mysql, hive, rabbitmq, odbc, postgreSQL, kingBaseES 存在用户名密码输入框 */}
                ...
                {/* mysql, hive, as7, odbc, postgreSQL, kingBaseES存在路径字段 */}
                {([MYSQL, HIVE, SQLSERVER, MYSQLODBC, KINGBASEES, POSTGRESQL, KINGBASE, CLICKHOUSE].includes(
                  sourceType
                ) ||
                  sourceType.includes(AS)) && (
                  <div className="form-row">
