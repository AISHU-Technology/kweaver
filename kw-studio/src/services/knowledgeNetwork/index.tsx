 ...
 */
const knowledgeNetGet = async (data: any) => await apiService.axiosGetData(API.knowledgeNetGet, data);

/**
 * @description 获取知识网络列表
 */
const knowledgeNetGetByName = async (data: any) => await apiService.axiosGetData(API.knowledgeNetGetByName, data);

/**
 * @description 新建知识网络
 */
const knowledgeNetCreate = async (data: any) => await apiService.axiosPost(API.knowledgeNetCreate, data);

/**
 * @description 编辑知识网络
 */
const knowledgeNetEdit = async (data: any) => await apiService.axiosPost(API.knowledgeNetEdit, data);

/**
 * @description 删除知识网络
 */
const knowledgeNetDelete = async (knw_id: number) => await apiService.axiosPost(API.knowledgeNetDelete, { knw_id });

/**
 * @description 根据知识网络id获取其下面的知识图谱
 */
const graphGetByKnw = async (data: any) => {
  const getData = {
    filter: 'all',
    ...data
  };
 ...
 */
const ERROR_OBJECT_OUTPUT: Record<string, Record<string, string>> = {
...
const graphOutput = async (data: any, fileName: string): Promise<any> => {
  try {
 ...
 */
const ERROR_OBJECT_INPUT: Record<string, string> = {
...
const graphInput = async (data: any): Promise<any> => {
  try {
