 ...
 */
export const generateG6GraphDataByOntologyData = (ontologyData: KwBackEndOntologyDataProps): ReactG6GraphDataProps => {
...
export const generateG6GraphSourceDataByOntologyData = (
  ontologyData: KwBackEndOntologyDataProps
): ReactG6GraphSourceDataProps => {
...
const ontologyNodeConvertG6NodeSourceData = (ontologyNode: KwBackEndNodeDataProps) => {
  ...
  const nodeSourceData: ReactG6NodeSourceDataProps = {
    primary_key: ontologyNode.primary_key,
    vector_generation: ontologyNode.vector_generation,
    default_tag: ontologyNode.default_tag,
    uid: ontologyNode.name,
    entity_id: uniqueId,
...
const ontologyEdgeConvertG6EdgeSourceData = (ontologyEdge: KwBackEndEdgeDataProps) => {
  let attributes: any[] = [];
