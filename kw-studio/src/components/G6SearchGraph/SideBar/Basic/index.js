            ...
            {check === 'info' ? (
                ...
                {property.map((item, index) => {
                  return (
                    <div className="property-line" key={index.toString()}>
                      ...
                      <div className="value" title={String(item.v)}>
                        {String(item.v)}
                      </div>
                    </div>
                  );
              ...
              <div className="show-seting">
                ...
                >
                  ...
                  {_.map(SHOW_INFO.concat(property), (item, index) => {
                    if (item.n === 'name') return;
                    return (
                      <div className="set-show-item" key={String(item.n) + index}>
                        <Radio value={item.n} key={String(item.n) + index}>
                          {item.n}
                        </Radio>
                      </div>
                    );
