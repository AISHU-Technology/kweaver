...
class Log:
    def __init__(self):
        ...
        # write log to file
        # handler = logging.FileHandler("../logs/logging.txt")  # 添加本地日志输入，文件自己定义
    ...
    def log_debug(self, body):
        self.logger.debug(str(body))

    def log_warning(self, body):
        self.logger.warning(str(body))
