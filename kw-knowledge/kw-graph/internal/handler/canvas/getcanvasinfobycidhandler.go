...
func GetCanvasInfoByCIDHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := canvas.NewGetCanvasInfoByCIDLogic(r.Context(), svcCtx)
		resp, err := l.GetCanvasInfoByCID(&req)
		if err != nil {
			httpx.Error(w, err)
		} else {
