...
CREATE TABLE IF NOT EXISTS "graph_config_table" (
    ...
    "graph_ds" text null,
    "graph_otl" text null,
    "graph_KMap" text null,
    "rabbitmq_ds" INT default 0 not null,
    "step_num" INT default 1 null,
    "is_upload" TINYINT default 0 null,
    "KDB_name" VARCHAR(250) null,
    "KDB_name_temp" VARCHAR(250) null,
    "kg_data_volume" INT default 0 not null,
    "status" VARCHAR(100) null,
    "graph_update_time" VARCHAR(100) null,
    "knw_id" INT not null,
    PRIMARY KEY ("id")
);
...
CREATE TABLE IF NOT EXISTS "data_source_table" (
    ...
    "ds_address"  VARCHAR(256) null,
    "ds_port" INT null,
    "ds_path" text null,
    "extract_type" VARCHAR(20) null,
    "ds_auth" VARCHAR(50) null,
    "vhost" VARCHAR(50) null,
...
CREATE TABLE IF NOT EXISTS "ontology_table" (
    ...
    "otl_status" VARCHAR(50)  null,
    "entity" text null,
    "edge" text null,
    "used_task" text null,
    "all_task" text null,
    "identify_id" VARCHAR(50) null,
    "knw_id" INT null,
    "domain" VARCHAR(550) null,
    "otl_temp" text null,
    "canvas" text null,
    PRIMARY KEY ("id")
);
...
CREATE TABLE IF NOT EXISTS "graph_task_table" (
    ...
    "trigger_type" INT default 0 not null,
    "task_type" VARCHAR(50) null,
    "subgraph_ids" VARCHAR(100) default '[0]' null,
    "current_subgraph_id" INT default -1 null,
    "failed_subgraph_ids" text null,
    "stop_subgraph_ids" text null,
    "write_mode" VARCHAR(50) default 'skip' null,
    "successful_subgraph" text null,
    "timestamp" text null,
    PRIMARY KEY ("id")
);
...
CREATE TABLE IF NOT EXISTS "graph_task_history_table" (
    ...
    "entity_num" INT null,
    "edge_num" INT null,
    "graph_entity" INT null,
    "graph_edge" INT null,
    "error_report" text null,
    "entity_pro_num" INT null,
    "edge_pro_num" INT null,
    "trigger_type" INT default 0 not null,
    "task_type" VARCHAR(50) null,
    "count_status" TINYINT default 0 null,
    "subgraph_id" INT default 0 null,
...
CREATE TABLE IF NOT EXISTS "intelligence_records" (
    ...
    "knw_id" INT null,
    "entity_knowledge" INT null,
    "edge_knowledge" INT null,
    "data_number" INT null,
    "total_knowledge" INT null,
    "empty_number" INT default 0 null,
    "repeat_number" INT default 0 null,
    "entity_number" INT default 0 null,
    "edge_number" INT default 0 null,
    "data_quality_score" decimal(10,2) default -1.00 not null,
    "update_time" datetime null,
    "type" INT default 0 not null,
    PRIMARY KEY ("id")
);

CREATE INDEX IF NOT EXISTS intelligence_records_idx_intelligence_records_knw_id ON intelligence_records(knw_id);
CREATE INDEX IF NOT EXISTS intelligence_records_idx_intelligence_records_resource_id ON intelligence_records(resource_id);
...
CREATE TABLE IF NOT EXISTS "async_tasks" (
    ...
    "celery_task_id" VARCHAR(200) null,
...
CREATE INDEX IF NOT EXISTS async_tasks_idx_async_tasks_celery_task_id ON async_tasks(celery_task_id);
CREATE INDEX IF NOT EXISTS async_tasks_idx_async_tasks_relation_id ON async_tasks(relation_id);
...
CREATE TABLE IF NOT EXISTS "taxonomy" (
    ...
    "knw_id" INT null,
    "word_num" INT default 0 null,
    "deleted" TINYINT default 0 null,
    PRIMARY KEY ("id")
);

CREATE UNIQUE INDEX IF NOT EXISTS taxonomy_uk_name ON taxonomy("name", "knw_id");
...
CREATE UNIQUE INDEX IF NOT EXISTS taxonomy_custom_relation_uk_name ON taxonomy_custom_relation("name", "taxonomy_id");


CREATE TABLE IF NOT EXISTS "timer_crontab" (
    "id" INT not null IDENTITY(1, 1),
    "minute" VARCHAR(240) null,
    "hour" VARCHAR(96) null,
    "day_of_week" VARCHAR(64) null,
    "day_of_month" VARCHAR(124) null,
    "month_of_year" VARCHAR(64) null,
...
CREATE UNIQUE INDEX IF NOT EXISTS timer_task_uk_task_id ON timer_task("task_id");
...
CREATE TABLE IF NOT EXISTS "search_config" (
  ...
  "conf_content" text DEFAULT NULL,
...
CREATE UNIQUE INDEX IF NOT EXISTS search_config_uk_idx_search_config_conf_name ON search_config("conf_name");
...
CREATE INDEX IF NOT EXISTS t_event_log_idx_event_mod_type ON t_event_log("f_mod_type");
...
CREATE INDEX IF NOT EXISTS t_event_log_hist_idx_event_hist_mod_type ON t_event_log_hist("f_mod_type");
...
CREATE INDEX IF NOT EXISTS t_dict_item_idx_dict_item_dict_id ON t_dict_item("f_dict_id");
...
(
    ...
    f_req           TINYINT default 1 not null,
    ...
    CLUSTER PRIMARY KEY (f_param_id)
);
...
(
    ...
    f_model_series_desc_cn VARCHAR(150)  null,
    f_model_series_desc_us VARCHAR(150)  null,
    f_model_icon           VARCHAR(8000) not null,
    f_model_param_id       VARCHAR(200)  not null,
    CLUSTER PRIMARY KEY (f_model_series_id)
);
...
(
    ...
    f_update_by           VARCHAR(50)          null,
    f_update_time         datetime(6)          null,
    f_item_is_delete      TINYINT default 0 not null,
    f_type_is_delete      TINYINT default 0 not null,
    f_is_management       TINYINT default 0 not null,
    CLUSTER PRIMARY KEY (f_id)
);
...
(
    ...
    f_is_deploy           TINYINT default 0 not null,
...
', '[{"var_name": "language", "field_name": "language", "optional": false, "field_type": "textarea"}, {"var_name": "content", "field_name": "\u5185\u5bb9", "optional": false, "field_type": "textarea"}]', '', '', '{"language": "英文", "content": "你好吗"}', '', '2023-12-30 23:14:03.063213', '', '2023-12-30 23:14:03.063234', 0 from DUAL
